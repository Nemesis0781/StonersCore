...
public class ItemBuilder {
    ...
    public ItemBuilder setColor(fr.nemesis07.stoners.bukkit.utils.Color color){
        is.setDurability((byte) color.getColorInt());
        return this;
    }
    /**
    ...
    public ItemBuilder setLore(String... lore){
        ...
        for(String line: Arrays.asList(lore)) {
